...
const CircularWebcam = ({ endpointUrl, numImages, onResponse,buttonLabel = "Mark Attendance" }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div style={{ width: '300px', height: '300px', borderRadius: '50%', borderWidth: "2px", borderColor: "green", overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <Webcam
          audio={false}
          ref={webcamRef}
          screenshotFormat="image/jpeg"
          videoConstraints={{ width: 640, height: 680 }}
          style={{ width: "640px", height: "680px", borderRadius:"600px" }}
        />
      </div>
      {!isLoading && (
        <button
      ...
      {isLoading && (
        <div className="mt-6 text-xl font-semibold text-blue-500">Processing, please wait...</div>
      )}
    </div>
  );
};
